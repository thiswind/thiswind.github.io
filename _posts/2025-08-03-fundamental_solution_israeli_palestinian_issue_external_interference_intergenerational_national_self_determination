---
layout: post
title: "巴以问题的根本出路：从外部干预的历史根源到面向世代责任的民族自决"
...
# الحل الجذري للمسألة الفلسطينية-الإسرائيلية: من الجذور التاريخية للتدخل الخارجي إلى تقرير المصير القومي الموجه نحو المسؤولية بين الأجيال
</div>
